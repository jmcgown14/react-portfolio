...
export default function Resume() {
  return (
    <div>
      ...
      <h1>About Me</h1>
  <p>
    Results-oriented professional transitioning into the tech industry with a background in admissions, finance, and customer service. Certified in Full-Stack Web Development, merging candidate evaluation expertise with technical skills. Strong in managing pipelines, meeting deadlines, and ensuring compliance. Proficient in HTML, CSS, JavaScript, Node.js, React.js, Express.js, MongoDB, and more. Seeking to drive innovation and contribute to cutting-edge projects. Let's connect and explore how my unique blend of experiences can add value to your organization's tech initiatives.
  </p>
  ...
  <ul>
    ...
    <li>Audited applications to make sure all necessary information and files were uploaded as well as facilitate interviews for applicants within my pipeline of calls.</li>
  ...
  <ul>
    ...
    <li>Maintain current knowledge and consistent compliance with Bank Secrecy Act and Banking regulations.</li>
  ...
  <ul>
    ...
    <li>Used technology and different assets to find effective and efficient methods in solving difficult needs for clients.</li>
  ...
  <ul>
    ...
    <li>Maintained an Excel database of all information used for planning major events on campus.</li>
    <li>Managed a 10 state territory by developing contacts at high schools and maintaining a database of 200+ applicants.</li>
  </ul>
  ...
  <ul>
    ...
    <li>Salesforce Lightning (CRM)</li>
  </ul>
      </section>
    </div>
  );
